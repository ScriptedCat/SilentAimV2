--[[
    Modded Version by Cat.py
]]

-- // Dependencies
local Library, AimingTab, _ = loadstring(game:HttpGet("https://raw.githubusercontent.com/ScriptedCat/ModdedUI/main/GUI.lua"))()
local Aiming = loadstring(game:HttpGet("https://raw.githubusercontent.com/ScriptedCat/ModdedUI/main/Load.lua"))()("Module")
...
local Configuration = {
    ...
    Keybind = Enum.KeyCode.L, -- // You can also have Enum.KeyCode.E, etc.
